		...
		<div class="row row-lg">
			<div class="col-lg-12">
			    <div class="example-wrap">
					                    ...
					                    @endif
						              	...
						              	@if(Auth::user()->tipo == 'Administrador')
							              	<td class="text-center">
						              			<a href="{{URL::action('MedicoController@edit',$var->id)}}" class="panel-action icon md-edit ml-15" data-toggle="tooltip" data-original-title="Editar" data-container="body" title=""></a>
			      	...
			      	<div>
				      	{{ $medicos->links('admCentros.custom') }}
				      	@if(Auth::user()->tipo == 'Administrador')
