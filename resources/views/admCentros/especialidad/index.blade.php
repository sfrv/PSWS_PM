					                    ...
					                    @endif
						              	...
						              	@if(Auth::user()->tipo == 'Administrador')
							             	<td class="text-center">
						              			<a href="{{URL::action('EspecialidadController@edit',$var->id)}}" class="panel-action icon md-edit ml-15" data-toggle="tooltip" data-original-title="Editar" data-container="body" title=""></a>
