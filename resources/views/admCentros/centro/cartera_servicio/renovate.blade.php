		              	...
		              	<div class="row">
		              		<div class="col-lg-4 col-xs-12">
		                  		<div class="form-group form-material floating" data-plugin="formMaterial">
				                	<input required type="text" class="form-control" name="titulo" value="{{$cartera_servicio->titulo}}"/>
...
for(i=0;i<servicios.length;i++){
    ...
    var fila_opcion = '<div id="fila_op'+cont+'" style="padding-bottom: 5px;">'+
        '<button type="button" class="btn btn-icon btn-danger" onclick="eliminar('+cont+','+servicios[i]['id']+');"><i class="icon md-close"></i></button>'+
      '</div>';
