			    ...
			    <div class="example-wrap">
			      	<div class="row">
			      		<div class="col-lg-9 col-xs-12">
			      			<h4>Editar Rol de Turno - Etapa Consulta Externa</h4>
			      		</div>
			      	...
			      	<br>
			      	{!! Form::model($id_rol_turno,['method'=>'PATCH','autocomplete'=>'off','route'=>['update-rol-turno-consulta',$id_rol_turno,$id_centro]])!!}
					{{Form::token()}} 
		              	<div>
